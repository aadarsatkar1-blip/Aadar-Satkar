...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // OPEN MODAL FUNCTION
    // ========================================
    function openModal(destinationLabel, destinationTitle, destinationImage) {
        // Set modal title
        if (modalTitle) {
        ...
        // Hide price section (no pricing feature)
    ...
    allCards.forEach((card, index) => {
        ...
        card.addEventListener('click', function (e) {
            ...
            const destinationLabel = labelElement ? labelElement.textContent.trim() : `Destination ${index + 1}`;
            ...
            openModal(destinationLabel, destinationTitle, destinationImage);
